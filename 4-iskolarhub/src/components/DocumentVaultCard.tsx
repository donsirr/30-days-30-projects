...
export default function DocumentVaultCard() {
    ...
    return (
        <motion.div
            ...
            className="col-span-1 md:col-span-1 md:row-span-1 bg-white rounded-[2rem] p-6 border border-[#1A365D]/10 shadow-sm hover:shadow-md transition-all flex flex-col"
        >
